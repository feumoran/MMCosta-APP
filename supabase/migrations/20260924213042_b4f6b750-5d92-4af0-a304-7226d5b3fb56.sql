ALTER TABLE public.funcionario_remuneracoes
ADD COLUMN bonus_mensal numeric NOT NULL DEFAULT 0;

ALTER TABLE public.funcionario_remuneracoes
ADD CONSTRAINT funcionario_remuneracoes_bonus_nao_negativo CHECK (bonus_mensal >= 0);
